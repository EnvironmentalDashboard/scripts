...
//   cron($db, $bos, $meter, $res, $amount, $user['id'], false, true, false); // Will update all the meters associated with the $user_id and (gauges_using > 0 OR for_orb > 0 OR timeseries_using > 0) OR bos_uuid IN (SELECT DISTINCT meter_uuid FROM relative_values WHERE permission = 'orb_server')
// }
