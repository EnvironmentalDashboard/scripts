...
//   cron($db, $bos, $meter, $res, $amount, $user['id'], true, false, true); // Will update all the meters associated with the $user_id and (gauges_using > 0 OR for_orb > 0 OR orb_server > 0 OR timeseries_using > 0)
// }
